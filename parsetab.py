...
_lr_productions = [
  ...
  ('statement -> Var Space NAME','statement',3,'p_statement_create_empty','compYacc.py',31),
  ('statement -> expression','statement',1,'p_statement_expr','compYacc.py',40),
  ('expression -> INT','expression',1,'p_expression_Number','compYacc.py',47),
  ('expression -> FLOAT','expression',1,'p_expression_Number','compYacc.py',48),
  ('expression -> function','expression',1,'p_expression_Number','compYacc.py',49),
  ('expression -> NAME','expression',1,'p_expression_name','compYacc.py',55),
  ('operaciones -> expression Space expression','operaciones',3,'p_operaciones','compYacc.py',65),
  ('operaciones -> expression Space operaciones','operaciones',3,'p_operaciones','compYacc.py',66),
